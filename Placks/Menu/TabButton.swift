...
struct TabButton: View {
    ...
    var body: some View {
        ...
        Button(action: {
            ...
            TabButtons(colorTabBG: darkmode ? .black : .white, colorTabTextSelected: darkmode ? .white : .blue, colorTabText: darkmode ? .gray : .white, imageTab: image, selectedTAB: selectedTab, theText: title, animation: animation)
